...
def update_google_sheet(order_number, sku):
    ...
    range_name = f'WH to CS OOS Comms!A{first_empty_row}'
...
def index():
    if request.method == 'POST':
        ...
        if update_google_sheet(order_number, sku):
            flash('Data successfully added to the spreadsheet.', 'success')
        else:
            flash('An error occurred while updating the spreadsheet.', 'error')
